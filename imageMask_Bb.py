...
path = "/nfs001/kavya/inputData/M/*.png"
path1 = "/nfs001/kavya/inputData/Back_main1/"


for main_image in sorted(glob.glob('/nfs001/kavya/inputData/Back/*.png')):
